...
const ROUTES = [
  ...
  { path: "/simulador-conta", priority: "0.8" },
  { path: "/economia-solar", priority: "0.8" },
  { path: "/dimensionar-solar", priority: "0.8" },
  { path: "/consumo-aparelhos", priority: "0.8" },
  { path: "/tarifa-branca", priority: "0.8" },
  { path: "/bandeiras", priority: "0.8" },
