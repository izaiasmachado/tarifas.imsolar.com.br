...
export const ROUTES: RouteMeta[] = [
  ...
  { path: "/ranking", sitemap: true, priority: 0.8 },
  { path: "/comparar", sitemap: true, priority: 0.8 },
  { path: "/simulador-conta", sitemap: true, priority: 0.8 },
  { path: "/economia-solar", sitemap: true, priority: 0.8 },
  { path: "/dimensionar-solar", sitemap: true, priority: 0.8 },
  { path: "/consumo-aparelhos", sitemap: true, priority: 0.8 },
  { path: "/tarifa-branca", sitemap: true, priority: 0.8 },
  { path: "/bandeiras", sitemap: true, priority: 0.8 },
